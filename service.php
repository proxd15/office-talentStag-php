...
<section class="about-us pt-3" id="service-us">
    <div>
        <div class="row">
            <div class="col-md-6 col-lg-6 ">
                <img src="img/hire.svg" class="res-con img-fluid">

            </div>
            <div class="col-md-6 col-lg-6 mt-lg-3">
...
<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 262 215" width="30" height="40"
    style="transform: rotate(20deg); margin-left:2rem">
    <defs>
...
<section class="mb-5">
    ...
    <div class="d-flex justify-content-center respo-proc">
        ...
        <div class="card mx-4 process1 spr">
...
<section style="background-color:#d7f0ff">
    <div class="container text-center mt-5 py-5">
        ...
        <div>
            <p> Payroll Management Outsourcing put in simple words, means delegating payroll administration to a
                ...
                Talent Stag offers tailored payroll choices that are specifically created for your company and will
                accelerate your process with enhanced accuracy and efficiency.
            </p>
        </div>
...
<section class="text-center my-4 mx-3">
    <div class="container">
        ...
        <div class="row">
            <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 262 215" width="30" height="40"
                class="last-tria" style="left:-2rem">
                <defs>
                    <clipPath clipPathUnits="userSpaceOnUse" id="cp1">
                        <path d="m322 580h-1000v-1000h1000z" />
                    </clipPath>
...
<section>
    <div class="my-5">
        ...
        <div style="display:flex; justify-content: end; margin-right: 3rem;">
            <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 262 215" width="30" height="40"
                class="d-none d-md-block" style="transform: rotate(90deg);">
                <defs>
                    <clipPath clipPathUnits="userSpaceOnUse" id="cp1">
                        <path d="m322 580h-1000v-1000h1000z" />
                    </clipPath>
        ...
        <h1 class="text-center mb-5">Types of Outsourcing</h1>
...
<div class="d-flex justify-content-end">
    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 262 215" width="50" height="70"
        class="last-tria">
        <defs>
            <clipPath clipPathUnits="userSpaceOnUse" id="cp1">
                <path d="m322 580h-1000v-1000h1000z" />
